...
module.exports = {
  name: "forceban",
  category: "moderation",
  description: "ForceBan anyone with one shot whithout knowing anyone xD",
  ...
  run: async (client, message, args) => {
    ...
    const target = client.findMember(message, args, false)
   ...
   if(!args[1]) {
    ...
    .setTitle("Action : ForceBan")
    .setDescription(`ForceBanned ${target.username} (${target.id})`)
    .setColor("#ff2050")
