...
const setAuditChannel = (guildId, channel) =>
  db.set(`logchannel_${guildId}`, channel);

/**
 * @param {String} guildId
 */
const getAuditChannel = (guildId) => db.fetch(`logchannel_${guildId}`);

/**
 * @param {String} guildId
 */
const unsetAuditChannel = (guildId) => db.delete(`logchannel_${guildId}`);
